...
function basic(det){
	...
	var addrs1= document.createElement("p");
	addrs1.textContent=det.Address;
	child1.append(addrs1);
...
function education(edu){
	...
	for(i=0;i<edu.length;i++){
		tabledata+="<tr><td>"+edu[i].institute+"</td><td>"+edu[i].degree+"</td><td>"+edu[i].passoutyear+"</td><td>"+edu[i].score+"</td></tr>";
	}
